...
User.create(firstname: "Dan", lastname: "O'Dea", username: 'dansband', password: 'expertleveldrinker', password_confirmation: 'expertleveldrinker', email: "dan@dan.com", age: 100, bio: 'Amateur bartender, musician, and programmer.')
